...
export interface EntPatientEdges {
     ...
     */
    patient?: Array<EntPatientofphysician>;
}
...
export function EntPatientEdgesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntPatientEdges {
    ...
    return {
        ...
        'patient': !exists(json, 'patient') ? undefined : ((json['patient'] as Array<any>).map(EntPatientofphysicianFromJSON)),
    };
}
...
export function EntPatientEdgesToJSON(value?: EntPatientEdges | null): any {
    ...
    return {
        ...
        'patient': value.patient === undefined ? undefined : ((value.patient as Array<any>).map(EntPatientofphysicianToJSON)),
    };
}
