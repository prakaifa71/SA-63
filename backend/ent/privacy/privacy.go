...
// The PatientofphysicianQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PatientofphysicianQueryRuleFunc func(context.Context, *ent.PatientofphysicianQuery) error

// EvalQuery return f(ctx, q).
func (f PatientofphysicianQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PatientofphysicianQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.PatientofphysicianQuery", q)
}

// The PatientofphysicianMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PatientofphysicianMutationRuleFunc func(context.Context, *ent.PatientofphysicianMutation) error

// EvalMutation calls f(ctx, m).
func (f PatientofphysicianMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.PatientofphysicianMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.PatientofphysicianMutation", m)
}

// The PatientroomQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PatientroomQueryRuleFunc func(context.Context, *ent.PatientroomQuery) error

// EvalQuery return f(ctx, q).
func (f PatientroomQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PatientroomQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.PatientroomQuery", q)
}

// The PatientroomMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PatientroomMutationRuleFunc func(context.Context, *ent.PatientroomMutation) error

// EvalMutation calls f(ctx, m).
func (f PatientroomMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.PatientroomMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.PatientroomMutation", m)
}
