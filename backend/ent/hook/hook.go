...
// The PatientofphysicianFunc type is an adapter to allow the use of ordinary
// function as Patientofphysician mutator.
type PatientofphysicianFunc func(context.Context, *ent.PatientofphysicianMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PatientofphysicianFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PatientofphysicianMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PatientofphysicianMutation", m)
	}
	return f(ctx, mv)
}

// The PatientroomFunc type is an adapter to allow the use of ordinary
// function as Patientroom mutator.
type PatientroomFunc func(context.Context, *ent.PatientroomMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PatientroomFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PatientroomMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PatientroomMutation", m)
	}
	return f(ctx, mv)
}
